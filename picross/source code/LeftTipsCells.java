...
LeftTipsCells is used to store the tip cells on the left.
 *
 * @version      
...
public class LeftTipsCells extends TipsCell{
	/**  
    Construct the left tip cell.
    
    @param row The row of the tip cell
    @param col The column of the tip cell
    @param tipsNum The tip number of the tip cell
    */
	public LeftTipsCells(int row, int col, int tipsNum) {
